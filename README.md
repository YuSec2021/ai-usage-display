...
> 当前版本：1.0.1。仓库包含原生 macOS 工程、Codex/Claude Code/Claude Desktop 数据采集、三态主题、历史图表、设置页、测试和视觉原型。
...
构建结果位于 `dist/AI-Usage-1.0.1.dmg`，并同时生成 SHA-256 校验文件。该版本没有 Developer ID 签名，也没有经过 Apple 公证。其他用户首次打开时，需要在 Finder 中右键应用并选择“打开”；如果系统仍然阻止运行，请前往“系统设置 → 隐私与安全性”选择“仍要打开”。
